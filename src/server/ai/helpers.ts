...
import { FocusedFill, FocusedFillSchema } from '../../shared/agent/format/FocusedFill'
import { FocusedShape } from '../../shared/agent/format/FocusedShape'
import { ContextItem } from '../../shared/agent/types/ContextItem'
import { SimpleShapeId } from '../../shared/agent/types/ids-schema'
import type { AgentLike as TldrawAgent } from './agent'
